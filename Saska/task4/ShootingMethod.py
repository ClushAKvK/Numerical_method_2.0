...
class Method:
    ...
    def shooting_method(self):
        ...
        # last_n = -100
        am = AdamsMethod(self.a, self.b, [self.A, last_n])
        last_y = am.adams_method(func)

        # n = 100
        n = random.random() * 100
        am = AdamsMethod(self.a, self.b, [self.A, n])
        y = am.adams_method(func)
        ...
        mid_n = (n + last_n) / 2
        am = AdamsMethod(self.a, self.b, [self.A, mid_n])
        mid_y = am.adams_method(func)
